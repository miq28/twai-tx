...
bool getTiming(uint32_t baud, twai_timing_config_t &timing)
{
    ...
    case 83333:
        timing.brp = 48; timing.tseg_1 = 15; timing.tseg_2 = 4; timing.sjw = 3; timing.triple_sampling = false;
        return true;
    case 33333:
        timing.brp = 120; timing.tseg_1 = 15; timing.tseg_2 = 4; timing.sjw = 3; timing.triple_sampling = false;
        return true;
    default:
        return false;
    }
